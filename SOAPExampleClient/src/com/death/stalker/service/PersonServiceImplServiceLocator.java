...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.death.stalker.service.PersonServiceImplService {
    ...
    public com.death.stalker.service.PersonServiceImpl getPersonServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.death.stalker.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.death.stalker.service.PersonServiceImplSoapBindingStub _stub = new com.death.stalker.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.death.stalker.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.death.stalker.service.PersonServiceImplSoapBindingStub _stub = new com.death.stalker.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.stalker.death.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.stalker.death.com", "PersonServiceImpl"));
        }
